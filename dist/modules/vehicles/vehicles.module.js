...
exports.VehiclesModule = VehiclesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [vehicles_service_1.VehiclesService, vehicle_select_service_1.VehicleSelectService],
        exports: [vehicles_service_1.VehiclesService, vehicle_select_service_1.VehicleSelectService]
    })
], VehiclesModule);
